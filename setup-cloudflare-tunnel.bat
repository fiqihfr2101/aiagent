@echo off
REM ============================================================
REM Cloudflare Tunnel Setup untuk H.E.R.M.E.S. Dashboard
REM Domain: orc.frackment.id
REM ============================================================

echo.
echo ========================================
echo  Cloudflare Tunnel Setup - H.E.R.M.E.S.
echo  Domain: orc.frackment.id
echo ========================================
echo.

REM Step 1: Login ke Cloudflare
echo [Step 1/5] Login ke Cloudflare...
echo.
echo Browser akan terbuka, silakan:
echo 1. Login ke Cloudflare
echo 2. Pilih domain: frackment.id
...
echo [Step 4/5] Membuat konfigurasi...
...
echo ingress:
echo   # Dashboard
echo   - hostname: orc.frackment.id
echo     service: http://localhost:3000
echo     originRequest:
echo       noTLSVerify: true
echo.
echo   # API
echo   - hostname: api.orc.frackment.id
...
echo [Step 5/5] Setup DNS Records
echo.
echo ============================================================
